...
**2)** Copy the Wavesui Hud folder (**NOT** Wavesui-Hud-Master, the one inside it!)

**3)** Paste The folder to your custom tf folder (C:\Program Files (x86)\Steam\SteamApps\common\Team Fortress 2\tf\custom\Wavesui Hud)
...
The original rgb code for the damage numbers is: hud_combattext_red 155; hud_combattext_green 236; hud_combattext_blue 87
